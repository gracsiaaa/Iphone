...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/cart/variants/{variant}', [CartController::class, 'update'])->name('cart.update');
    Route::delete('/cart/variants/{variant}', [CartController::class, 'destroy'])->name('cart.destroy');
